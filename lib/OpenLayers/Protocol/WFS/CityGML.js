 ...
 * @requires OpenLayers/Format/WFST/CityGML.js
 */

/**
 * Class: OpenLayers.Protocol.WFS.CityGML
 * A WFS v2.0.0 protocol for vector layers.  Create a new instance with the
 *     <OpenLayers.Protocol.WFS.CityGML> constructor.
 *
 ...
 */
OpenLayers.Protocol.WFS.CityGML = OpenLayers.Class(OpenLayers.Protocol.WFS.v1, {
    ...
    /**
     * Constructor: OpenLayers.Protocol.WFS.CityGML
     ...
     */
	 initialize: function(options) {
	        ...
	        if(!options.format) {
	            this.format = new OpenLayers.Format.WFST.CityGML(OpenLayers.Util.extend({
    ...
    CLASS_NAME: "OpenLayers.Protocol.WFS.CityGML"
});
