    ...
    readers: {
        ...
        "feature": {
            ...
            "_typeName": function(node, obj) {
                ...
                var url = this.lookupNamespaceURI(node, "gml");
                var prefix = this.namespaceAlias[url] ? this.namespaceAlias[url] : "gml";
                var fid = node.getAttribute("fid") ||
                    this.getAttributeNS(node, this.namespaces[prefix], "id");
                if(fid) {
                    feature.fid = fid;
                }
        ...
        "iso19112": {
        	...
        	"geographicIdentifier": function(node, obj) {
        		var local = node.localName || node.nodeName.split(":").pop();
        		var value = this.getChildValue(node);
        		obj.attributes[local] = value;
        	},
        	"parent": function(node, obj) {
        		var local = node.localName || node.nodeName.split(":").pop();
        		var value = this.getChildValue(node);
        		obj.attributes[local] = value;
        	}
